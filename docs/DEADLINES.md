...
Checked live in Safari on **17 September 2026**, approximately **20:10 Asia/Dubai (UTC+04:00)**. Course assignment index and the lab page are authoritative for the entries below. A displayed 00:00 cutoff is the start of that date, so finish the preceding evening.
...
| [F – Finish](https://lms.mbzuai.ac.ae/mod/assign/view.php?id=38968) | 10 Oct 2026 00:00 | 9 Oct evening | No submission | Future |

[C – Charter](https://lms.mbzuai.ac.ae/mod/assign/view.php?id=38960), due 9 Sep, and [B phase](https://lms.mbzuai.ac.ae/mod/assign/view.php?id=37861), due 3 Sep, both show **Submitted for grading**. The earlier B submission was recorded as CampusCrew in prior project context; do not infer it contains the revised ClassMic B2. Refreshing local A–C files does not resubmit them.
